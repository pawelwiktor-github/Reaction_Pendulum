...
% Define Mamdani FIS
fisTS_ver2 = sugfis('Name', 'PendulumControlver2', ...
                            AndMethod="min", ... 
                            OrMethod="max", ...
...
% Inputs
fisTS_ver2 = addInput(fisTS_ver2, [pend_angle_min pend_angle_max], 'Name', 'pend_angle');
fisTS_ver2 = addInput(fisTS_ver2, [pend_vel_min pend_vel_max], 'Name', 'pend_vel');
fisTS_ver2 = addInput(fisTS_ver2, [rotor_vel_min rotor_vel_max], 'Name', 'rotor_vel'); 

% Outputs
fisTS_ver2 = addOutput(fisTS_ver2, [control_min control_max] , 'Name', 'control'); 

%% Membership functions

% Inputs
% Pendulum Angle
fisTS_ver2 = addMF(fisTS_ver2,"pend_angle","trimf",[-3.14159 -0.5 0], ...
    Name="Left",VariableType="input");
fisTS_ver2 = addMF(fisTS_ver2,"pend_angle","trimf",[-0.08 0 0.08], ...
    Name="Center",VariableType="input");
fisTS_ver2 = addMF(fisTS_ver2,"pend_angle","trimf",[0 0.5 3.14159], ...
    Name="Right",VariableType="input");

% Pendulum Velocity
fisTS_ver2 = addMF(fisTS_ver2,"pend_vel","trimf",[-4.2 -2.1 0], ...
    Name="Left",VariableType="input");
fisTS_ver2 = addMF(fisTS_ver2,"pend_vel","trimf",[-0.12 0 0.12], ...
    Name="Zero",VariableType="input");
fisTS_ver2 = addMF(fisTS_ver2,"pend_vel","trimf",[0 2.1 4.2], ...
    Name="Right",VariableType="input");
% Rotor Velocity
fisTS_ver2 = addMF(fisTS_ver2,"rotor_vel","trimf",[-450 -260 0], ...
    Name="Negative",VariableType="input");
fisTS_ver2 = addMF(fisTS_ver2,"rotor_vel","trimf",[-30 0 30], ...
    Name="Zero",VariableType="input");
fisTS_ver2 = addMF(fisTS_ver2,"rotor_vel","trimf",[0 260 450], ...
    Name="Positive",VariableType="input");

% Outputs
% Control Signal
fisTS_ver2 = addMF(fisTS_ver2,"control","constant",-6.7333, ...
    Name="Negative",VariableType="output");
fisTS_ver2 = addMF(fisTS_ver2,"control","constant",0, ...
...
% Add rules to FIS
fisTS_ver2 = addRule(fisTS_ver2, ruleList);
...
figure()
subplot(3,1,1)
plotmf(fisTS_ver2,"input",1)
subplot(3,1,2)
plotmf(fisTS_ver2,"input",2)
subplot(3,1,3)
plotmf(fisTS_ver2,"input",3)
% subplot(4,1,4)
...
% Set Param
set_param(blockPath, 'fis', 'fisTS_ver2');
...
save('secondFuzzy.mat', 'PendPosLQR', 'PendPosTS', ...
